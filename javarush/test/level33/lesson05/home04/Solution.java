...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String sOne = one.getClass().getSimpleName().toLowerCase();
        String resultString = resultClassObject.getSimpleName().toLowerCase();
        StringReader stringReader = new StringReader(stringWriter.toString().replaceFirst(sOne, resultString));
